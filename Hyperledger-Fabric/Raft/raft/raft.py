...
class RaftNode(threading.Thread):
    ...
    def process_client_request(self, entry, start_time):
        ...
        # Here, we're assuming the request is appended to the log
        self.log.append(entry)
        self.commit_index += 1

        # Calculate the latency for this request (in milliseconds)
        ...
        # If a second has passed, print the throughput and reset counters
