 ...
 */
class CreateChitWorkload extends WorkloadModuleBase {
    /**
    ...
    async submitTransaction() {
        ...
        let args = {
            ...
            contractVersion: 'v1',
            contractFunction: 'createChit',
            contractArguments: [chitNumber, company_type, ownerregistration_no, company_name, PAN],
            timeout: 30
        };
