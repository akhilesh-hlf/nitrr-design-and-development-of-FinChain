...
registerUsers() {
  ...
  fabric-ca-client register --caname ca.org2.example.com --id.name peer2 --id.secret peer2pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
  
  echo
  echo "Register peer3"
  echo

  fabric-ca-client register --caname ca.org2.example.com --id.name peer3 --id.secret peer3pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
